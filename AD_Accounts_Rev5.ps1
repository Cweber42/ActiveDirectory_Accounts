...
#Import-Csv $csv | Where {$_.'Current Building' -ne "9"} | Export-Csv $csvfiltered
...
$csv1 = Import-Csv -Path $csvreport  -header 'Student ID','Firstname','Lastname','Graduation Year','Grade','Gender','Current Building' #Replace with $csvfiltered if using filter
